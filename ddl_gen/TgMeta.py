...
class TgMeta(object):
    """Helper class that collects metadata for further use."""
    ...
    def _processGsqlLs(self):
        ...
        while i < len(res):
            ...
            # Processing queries
                ...
                while l != "":
                    qName = l[4:l.find("(")]
                    txt = self.conn.gsql("SHOW QUERY " + qName).rstrip(" \n")
            ...
            # Processing data sources
                ...
                while l != "":
                    ...
                    ds = {
                        ...
                        "Type": dsDetails[0],
                        "Details": dsDetails[2],
                        "Statement": "CREATE DATA_SOURCE " + dsDetails[0].upper() + " " + dsDetails[1] + ' = "' + dsDetails[2].lstrip("(").rstrip(")").replace('"', "'") + '"',
                        "Statement2": "GRANT DATA_SOURCE " + dsDetails[1] + " TO GRAPH " + self.conn.graphname
                    }
